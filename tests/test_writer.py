...
def test_iter_lines_ignores_dependencies_of_unsafe(from_line, writer):
    ...
    expected = [
        '\x1b[32m#\x1b[0m',
        '\x1b[32m# This file is autogenerated by Pip Requ\x1b[0m',
        '\x1b[32m# To update, run:\x1b[0m',
        '\x1b[32m#\x1b[0m',
        '\x1b[32m#    pip-requ compile --output-file dst_file src_file src_file2\x1b[0m',
        '\x1b[32m#\x1b[0m',
        'test',
        '',
